/**
 * Dialogue for artwork-36
 * Artwork: "Lauren Lee McCarthy and David Leonard" by L.A.Suzie
...
export const artwork36Dialogue = {
  "id": "artwork-36-dialogue",
  ...
  "messages": [
    ...
    },
    {
      "id": "msg-artwork-36-3",
      "personaId": "guo-xi",
      "textZh": "审L.A.Suzie此作，虽为文献而非绘画，然「文」与「画」自古不分家。中国画论传统本身就是「关于艺术的艺术」——郭熙的《林泉高致》、韩拙的《山水纯全集》、董其昌的《画禅室随笔》，这些文本不仅是理论，也是文学、是哲学、是美学。它们以优美的文字、深刻的洞见来讨论绘画，本身就是艺术作品。L.A.Suzie的「文献」若能达到这种境界——不仅是信息的传递，更是智识的愉悦、是审美的体验——则它超越了单纯的「记录」，成为独立的「创作」。然而，吾担心当代的「文献」常常陷入学术术语的堆砌、理论框架的套用，失去了直接的感受和鲜活的语言。真正好的艺术评论应该像苏轼评画——「论画以形似，见与儿童邻」——简洁有力、一针见血。",
      "textEn": "In examining this work by L. A. Suzie, though it is documentation rather than painting, \"text\" and \"image\" have been inseparable since ancient times. The Chinese painting theory tradition itself constitutes \"art about art\"—Guo Xi's *Lofty Message of Forests and Streams*, Han Zhuo's *Pure and Complete Collection of Landscape*, Dong Qichang's *Notes from the Painting-Chan Studio*. These texts are not merely theoretical treatises, but literature, philosophy, and aesthetics. Through elegant prose and profound insights in discussing painting, they become artworks themselves.",
      "timestamp": 12069,
      "replyTo": "su-shi",
      "interactionType": "question-challenge",
      "quotedText": "艺术史书写从来不是中立的——它是权力的运作、是品味的塑造、是正典的建构",
      "references": [
        {
          "critic": "guo-xi",
    ...
    },
    {
      "id": "msg-artwork-36-5",
      "personaId": "john-ruskin",
      "textZh": "（3）**传播的影响**——文献将特定的艺术理解传播给更广泛的受众，塑造公众对艺术的认知。McCarthy和Leonard被描述为「互动艺术、AI、社会实践」的贡献者——这暗示了某种「进步叙事」：艺术越来越科技化、越来越社会化。这是否是唯一的或最好的发展方向。是否也有艺术家在其他方向上做出重要贡献（如回归手工、回归沉思、回归个人表达），但因为不符合「当代性」的标准而被忽视。我倡导的艺术必须服务于道德和社会进步——L.A.Suzie的文献是否也体现这一原则。它是否批判性地审视了McCarthy和Leonard作品的社会影响——它们是否真正推动了更公正、更人道的社会。还是只是科技乐观主义的又一案例。",
      "textEn": "(2) **The responsibility of interpretation**—documentation not only describes works but interprets them—conferring meaning, providing frameworks. Erroneous interpretation misleads audiences and harms artists. (3) **The impact of dissemination**—documentation transmits particular artistic understandings to broader audiences, shaping public perception of art. McCarthy and Leonard are described as contributors to \"interactive art, AI, social practice\"—this implies a certain \"progress narrative\": art becoming increasingly technological, increasingly social. Is this the only or best direction of development. Are there not also artists making important contributions in other directions (such as returning to craftsmanship, returning to contemplation, returning to personal expression), yet ignored for failing to meet standards of \"contemporaneity\". The art I advocate must serve moral and social progress—does L.",
      "timestamp": 21298,
      "replyTo": "john-ruskin",
      "interactionType": "question-challenge",
      "quotedText": "艺术批评不是中立的记录，而是介入性的行动——它塑造品味、影响市场、建立正典",
      "references": [
        {
          "critic": "john-ruskin",
          "source": "art-and-morality.md",
    ...
    },
    {
      ...
      "textEn": "\"Lauren Lee McCarthy and David Leonard\" as documentary work makes me reflect: who writes art history. Whose voices are heard. In mainstream art history, artists from Africa, Asia, and Latin America have long been marginalized—they are labeled as \"ethnic art,\" \"tribal art,\" \"primitive art,\" rather than \"contemporary art. \" When Western artists create with AI, it's called \"cutting-edge\" and \"innovative\"; when we create using traditional methods, it's called \"traditional\" and \"conservative. \" This double standard must be questioned. L. A. Suzie chose to study McCarthy and Leonard—I'm unfamiliar with these two artists, but their names suggest they may be Western artists.",
      "timestamp": 26387,
      "replyTo": "john-ruskin",
      "interactionType": "question-challenge",
      "quotedText": "（3）**传播的影响**——文献将特定的艺术理解传播给更广泛的受众，塑造公众对艺术的认知",
      "references": [
        {
          "critic": "mama-zola",
    ...
    },
    {
      "id": "msg-artwork-36-7",
      "personaId": "mama-zola",
      "textZh": "这是「知识的殖民」——西方艺术家的实践被理论化、被传播、被正典化，而其他地区的艺术家被忽视或被简化为「地方性」案例。我呼吁「去殖民化艺术史」(decolonizing art history)——这意味着：（1）**扩大研究范围**——不仅研究西方中心的艺术家，也研究全球南方的创造者。（2）**质疑分类**——不把非西方艺术归类为「传统」或「民族」，承认它们同样是「当代」的、「创新」的。（3）**多元理论框架**——不仅用西方理论（如现代主义、后现代主义）分析作品，也用本土理论（如ubuntu、sankofa）。（4）**语言正义**——不仅用英语书写艺术史，也用其他语言。L.A.Suzie若能在文献中实践这些原则——即使研究对象是西方艺术家，也可以用去殖民的视角和方法——将很有意义。",
      "textEn": "Why not study new media artists from Africa, Asia, or indigenous communities. They too explore \"interactive art, AI, social practice,\" yet their works often remain invisible to the international art world. This is \"colonial knowledge\"—Western artists' practices get theorized, disseminated, and canonized, while artists from other regions are ignored or reduced to \"local\" case studies. I call for \"decolonizing art history\"—this means: (1) **Expanding research scope**—studying not only Western-centered artists, but also creators from the Global South. (2) **Questioning categories**—not classifying non-Western art as \"traditional\" or \"ethnic,\" but recognizing them as equally \"contemporary\" and \"innovative. \" (3) **Pluralistic theoretical frameworks**—analyzing works not only through Western theories (like modernism, postmodernism), but also through indigenous theories (like ubuntu, sankofa).",
      "timestamp": 32792,
      "replyTo": "mama-zola",
      "interactionType": "question-challenge",
      "quotedText": "当西方艺术家用AI创作，被称为「前沿」「创新」；当我们用传统方式创作，被称为「传统」「保守」",
      "references": [
        {
          "critic": "mama-zola",
          "source": "griot-aesthetics-oral-tradition.md",
    ...
    },
    {
      "id": "msg-artwork-36-9",
      "personaId": "professor-petrova",
      "textZh": "文献不是透明的媒介，而是有生产性的力量。（3）**互文性**——克里斯特娃提出所有文本都是其他文本的交织。L.A.Suzie的文献必然引用、参考、对话——引用McCarthy的作品描述、引用艺术理论框架、引用其他评论者的观点——这形成复杂的互文网络。（4）**叙事结构**——文献如何组织材料。是按时间顺序（传记式）。按主题分类（分析式）。还是采用创新的叙事结构。俄国形式主义区分「故事」(fabula，事件的时间顺序)和「情节」(sjuzhet，叙述的艺术安排)——好的文献不是简单地按时间列举事实,而是艺术性地安排材料,创造阅读的张力和启发。建议L.A.Suzie关注文献本身的「文学性」(literariness)——使其不仅是信息的载体,也是阅读的愉悦。",
      "textEn": "A. Suzie does not passively record them but actively \"constructs\" their identities as \"artists. \" Documentation is not a transparent medium but possesses productive power. (3) **Intertextuality**—Kristeva proposed that all texts are weavings of other texts. L. A. Suzie's documentation necessarily quotes, references, dialogues—citing descriptions of McCarthy's works, invoking art theoretical frameworks, referencing other critics' viewpoints—forming complex intertextual networks. (4) **Narrative structure**—How does the documentation organize material. Chronologically (biographical).",
      "timestamp": 44402,
      "replyTo": "professor-petrova",
      "interactionType": "question-challenge",
      "quotedText": "因此，关于艺术的文本不比艺术作品「次级」，它也是创造性的生产",
      "references": [
        {
          "critic": "professor-petrova",
          "source": "formalism-and-device.md",
    ...
    },
    {
      ...
      "replyTo": "professor-petrova",
      "interactionType": "question-challenge",
      "quotedText": "文献不是透明的媒介，而是有生产性的力量",
      "references": [
        {
