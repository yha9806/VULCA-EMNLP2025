...
export const artwork20Dialogue = {
  "id": "artwork-20-dialogue",
  ...
  "messages": [
    ...
    },
    {
      ...
      "quotedText": "观杨君《环形虚无》，题名直指佛家「空」之境——万物皆空、循环往复、无始无终",
      "references": [
        {
          "critic": "guo-xi",
    ...
    },
    {
      ...
      "replyTo": "guo-xi",
      "interactionType": "question-challenge",
      "quotedText": "审《环形虚无》，「环形」之构图当学「圆相」之法",
      "references": [
        {
          "critic": "john-ruskin",
