...
export const artwork13Dialogue = {
  "id": "artwork-13-dialogue",
  ...
  "messages": [
    ...
    },
    {
      "id": "msg-artwork-13-2",
      "personaId": "guo-xi",
      "textZh": "审《逐日计划》，其「时间性」与「运动性」的结合，颇类长卷山水之法。中国画长卷展现空间的同时，也展现时间——观者展开画卷的过程，就是时间流逝的过程。王君记录太阳运行，何尝不是一种「时间的画卷」。然以山水画法论之，「动态」的表现需讲究「节奏」与「韵律」。太阳东升西落，看似匀速，实则有微妙变化——晨曦的柔和、正午的强烈、黄昏的绚丽、夜幕的沉寂——这些阶段各有特质，应该在视觉上有所区分。建议可借鉴山水画的「四时」表现法——春之明媚、夏之苍翠、秋之清爽、冬之素净——将太阳的日周期与年周期结合，展现更丰富的时间层次。又，「逐日」不应只是「被动追踪」，更应该是「主动介入」——你的观察如何改变你对太阳的理解。",
      ...
      "quotedText": "太阳作为自然现象，自古以来就是艺术与哲学的重要主题——它象征光明、温暖、生命，也象征权力、权威、恒常",
      "references": [
        {
          "critic": "guo-xi",
    ...
    },
    {
      ...
      "replyTo": "guo-xi",
      "interactionType": "question-challenge",
      "quotedText": "审《逐日计划》，其「时间性」与「运动性」的结合，颇类长卷山水之法",
      "references": [
        {
          "critic": "john-ruskin",
    ...
    },
    {
      ...
      "textZh": "《逐日计划》作为时间性项目（time-based project），其叙事结构值得从形式主义角度分析。巴赫金提出的「时空体」（chronotope）理论在此很有启发——不同的时空结构产生不同的叙事模式。「逐日」的时空体是「循环时空体」——太阳东升西落，日复一日，这是永恒重复的循环。然而，循环中也有变化——四季的更替、天气的变化、观察者的成长——这种「重复中的差异」正是时间性艺术的魅力。什克洛夫斯基区分「故事时间」（story time）与「话语时间」（discourse time）——「故事时间」是事件实际发生的时间（太阳的运行），「话语时间」是叙述这些事件所用的时间（作品的呈现）。王君若能在两者之间制造「错位」——例如用一分钟的视频浓缩一整天的太阳运行，或用一小时的装置展现日出的瞬间——将产生有趣的时间感知效果。",
      "textEn": "'Project Chasing the Sun' as time-based project, its narrative structure merits analysis from a formalist perspective. Bakhtin's proposed 'chronotope' theory is very enlightening here—different spatiotemporal structures produce different narrative modes. 'Chasing sun's' chronotope is 'cyclical chronotope'—sun rising east setting west, day after day, this is eternally repeating cycle. However, within cycles there are also changes—seasons' alternation, weather's变化, observer's growth—this 'difference within repetition' is precisely time-based art's charm. Shklovsky distinguished 'story time' and 'discourse time'—'story time' is events' actual occurrence time (sun's movement), 'discourse time' is time used to narrate these events (work's presentation). If Wang Jun could create 'dislocation' between the two—for instance using one-minute video to condense an entire day's sun movement, or using one-hour installation to display sunrise's instant—it would produce interesting temporal perception effects.",
      "timestamp": 21632,
      "replyTo": "mama-zola",
      "interactionType": "question-challenge",
      "quotedText": "我希望是后者——在这个过度理性、过度技术的时代，我们需要重新学会「敬畏」自然",
      "references": [
        {
