...
export const artwork23Dialogue = {
  "id": "artwork-23-dialogue",
  ...
  "messages": [
    ...
    },
    {
      ...
      "quotedText": "再观洪君《岭南道中》（第二幅），「继续探索」四字道出创作的延续性",
      "references": [
        {
          "critic": "guo-xi",
    ...
    },
    {
      ...
      "replyTo": "guo-xi",
      "interactionType": "question-challenge",
      "quotedText": "审洪君《岭南道中》系列，「系列性」的处理至关重要",
      "references": [
        {
          "critic": "john-ruskin",
    ...
    },
    {
      "id": "msg-artwork-23-4",
      "personaId": "mama-zola",
      "textZh": "洪君两幅「岭南道中」，让我想起我们的「重访」传统。在我们的文化中，重要的地方需要多次造访——第一次是认识，第二次是理解，第三次是融入。每次重访，都会有新的发现、新的感受、新的关系。洪君的第二幅，是否体现了这种「重访」的深化。我希望能看到：第一幅是outsider的观看，第二幅是insider的体验；第一幅是观光客的惊叹，第二幅是居民的日常；第一幅是风景的exotic beauty，第二幅是生活的真实texture。这种转变，需要艺术家真正深入当地——不仅用眼睛看，更用心体会；不仅停留表面，更深入内部；不仅作为游客，更作为朋友。若洪君能做到这一点，两幅作品将形成有力的对话——关于如何真正理解一个地方、如何超越touristic gaze、如何建立真实的文化连接。",
      ...
      "replyTo": "john-ruskin",
      "interactionType": "question-challenge",
      "quotedText": "洪君创作两幅「岭南道中」，让我想起透纳的系列作品",
      "references": [
        {
          "critic": "mama-zola",
    ...
    },
    {
      ...
      "replyTo": "mama-zola",
      "interactionType": "question-challenge",
      "quotedText": "洪君两幅「岭南道中」，让我想起我们的「重访」传统",
      "references": [
        {
