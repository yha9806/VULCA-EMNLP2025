...
export const artwork19Dialogue = {
  "id": "artwork-19-dialogue",
  ...
  "messages": [
    ...
    },
    {
      ...
      "quotedText": "此种边缘立场，颇有禅宗「不立文字」之风——真理不在经典中，在经典之外；艺术不在画廊中，在画廊之外",
      "references": [
        {
          "critic": "guo-xi",
    ...
    },
    {
      ...
      "quotedText": "审《非池中》，若为空间概念，可借鉴「园林」之「隔与透」",
      "references": [
        {
          "critic": "john-ruskin",
    ...
    },
    {
      ...
      "replyTo": "mama-zola",
      "interactionType": "question-challenge",
      "quotedText": "在殖民者建立的「艺术池」中，非洲艺术从未被认真对待——它被视为「原始」「落后」「不文明」",
      "references": [
        {
