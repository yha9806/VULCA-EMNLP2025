/**
 * Dialogue for artwork-15
 * Artwork: "404词窟" by 修楚贺，张萌萌
...
export const artwork15Dialogue = {
  ...
  "messages": [
    ...
    },
    {
      "id": "msg-artwork-15-4",
      "personaId": "mama-zola",
      "textZh": "《404词窟》让我想起口述历史的脆弱性。在我们的传统中，历史不是写在书上，而是讲在嘴上、记在心里。当一位长者去世时，如果没有人继承他的故事，那些故事就永远消失了——这就是我们的「404」。因此，我们非常重视「传承」——每个故事都要讲给下一代，每个记忆都要有人接续。数字时代的「404」与此有相似之处——当一个网站关闭、一个平台消失时，那些内容也如同未被传承的口述历史，消失在虚空中。然而，也有不同之处：口述历史的消失是自然的（人的寿命有限），而数字内容的消失常常是人为的、突然的、暴力的（审查、删除、平台倒闭）。这种暴力性的遗忘，正是数字时代的新形式压迫。修君、张君的「数字考古」，可以视为对这种压迫的抵抗——通过挖掘、复原、展示被删除的内容，我们在对抗「强制性遗忘」。",
      ...
      "replyTo": "john-ruskin",
      "interactionType": "question-challenge",
      "quotedText": "《404词窟》让我思考「遗忘的权利」与「记忆的责任」之间的张力",
      "references": [
        {
          "critic": "mama-zola",
    ...
    },
    {
      ...
      "textZh": "《404词窟》触及AI时代最核心的伦理困境：谁控制记忆。在物理世界，图书可以被焚毁，但总有副本散落各处，完全消灭很难。在数字世界，中心化服务器的删除可以让内容瞬间、彻底、全球范围地消失——这种「完全遗忘」的能力，前所未有地集中在少数平台手中。更危险的是AI的「选择性遗忘」能力——推荐算法决定什么内容被看见、什么被埋没，这种「软性404」比硬性删除更隐蔽。大量有价值的内容因为不符合算法偏好，永远沉在搜索结果的第10页，事实上等同于404。我们需要追问：1）平台是否应该有无限的删除权。是否需要某种「数字遗产保护法」。2）AI训练数据中被删除的内容如何处理。这些「404」是否会导致AI对历史的片面理解。",
      ...
      "interactionType": "question-challenge",
      "quotedText": "《404词窟》从形式主义角度看，是对「缺席」(absence)的有趣探索",
      "references": [
        {
