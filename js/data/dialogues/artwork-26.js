...
export const artwork26Dialogue = {
  "id": "artwork-26-dialogue",
  ...
  "messages": [
    ...
    },
    {
      ...
      "textZh": "从叙事学角度看，《辩白书》是一种特殊的文本类型——「自我叙事」(self-narrative)与「防御性话语」(defensive discourse)的结合。巴赫金分析陀思妥耶夫斯基小说中的「地下室人」——一个不断向假想的批评者辩解、预判他人的指控并提前反驳的叙述者。辩白书具有相似的「对话性」(dialogism)结构——它不是独白，而是对话的一方，另一方是指控者（在场或不在场）。吴君的作品可以从几个层面分析：（1）**言语行为**——辩白是一种施为性话语(performative utterance)，它不仅是陈述，更是行动。说「我是无辜的」不仅是信息的传达，更是自我定位的尝试。（2）**修辞策略**——辩白使用哪些修辞装置。",
      "textEn": "From a narratological perspective, *Letter of Explanation* represents a distinctive textual type—a fusion of \"self-narrative\" and \"defensive discourse. \" Bakhtin analyzed the \"underground man\" in Dostoevsky's novels—a narrator who constantly justifies himself to imaginary critics, anticipating accusations and preemptively refuting them. The letter of explanation possesses a similar \"dialogic\" structure—it is not monologue, but one side of a dialogue, with the other being the accuser (present or absent). 吴振华's work can be analyzed on several levels: (1) **Speech act**—explanation is performative utterance; it is not merely statement, but action. Saying \"I am innocent\" is not only information transmission, but an attempt at self-positioning. (2) **Rhetorical strategy**—which rhetorical devices does the explanation employ.",
      "timestamp": 21505,
      "replyTo": "mama-zola",
      "interactionType": "question-challenge",
      "quotedText": "殖民者来到我们的土地，说我们「野蛮」「原始」「需要文明化」，要求我们证明自己配得上人的尊严",
      "references": [
        {
