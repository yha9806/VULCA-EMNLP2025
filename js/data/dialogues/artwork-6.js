/**
 * Dialogue for artwork-6
 * Artwork: "记忆潮汐--地平线系列" by 张凯飞
...
export const artwork6Dialogue = {
  "id": "artwork-6-dialogue",
  "artworkId": "artwork-6",
  "participants": [
    "su-shi",
    "guo-xi",
  ...
  "messages": [
    {
      "id": "msg-artwork-6-1",
      "personaId": "su-shi",
      "textZh": "观《记忆潮汐--地平线系列》，不禁忆及吾之江海人生。吾一生屡遭贬谪，从京城至黄州、惠州、儋州，每至一地，皆面对新的地平线。此作以抽象笔法绘地平线，而地平线者，人生之界限也，亦是无限之起点也。作者张君以「潮汐」喻记忆，深得「流水不争先」之理——记忆如潮，有涨有落，有清晰有模糊，此正人生之真相。中国画论常言「远山无皴」，越远越模糊，此作亦有此韵——地平线处，形象消融，如记忆之远去。然吾更欣赏其「留白」之美：画面大片虚空，恰如记忆中之空白，亦如人生中之未知。宋人画常留三分，七分虚实相生。此作若能更进一步，在抽象中显意境，在简淡中见性情，或可臻「澄怀观道」之境。吾尝作诗「人生到处知何似，应似飞鸿踏雪泥。",
      "textEn": "Observing 'Memory Tides - Horizon Series,' I cannot help but recall my own life of rivers and seas. Throughout my life, I have been repeatedly exiled, traveling from the capital to Huangzhou, Huizhou, and Danzhou, and at each place I faced a new horizon. This work depicts horizons through abstract brushwork, and horizons represent life's boundaries yet also infinite starting points. Artist Zhang uses 'tides' to metaphorize memory, profoundly grasping the principle of 'flowing water does not compete for precedence'—memory ebbs and flows like tides, sometimes clear, sometimes blurred; this is life's truth. Chinese painting theory often speaks of 'distant mountains without texture strokes'—the farther, the more blurred. This work possesses this resonance—at the horizon line, forms dissolve, like memories fading. Yet I appreciate more its beauty of 'leaving blank': vast empty spaces in the composition, like blanks in memory, like unknowns in life. Song dynasty paintings often leave three parts filled, seven parts void and solid mutually generating. If this work could advance further, displaying artistic conception within abstraction, revealing temperament within elegant simplicity, it might approach the realm of 'purifying the mind to contemplate the Way.",
      "timestamp": 0,
      "replyTo": null,
    ...
    },
    {
      ...
      "replyTo": "john-ruskin",
      "interactionType": "question-challenge",
      "quotedText": "《记忆潮汐--地平线系列》让我思考艺术中「真实」的问题",
      "references": [
        {
          "critic": "mama-zola",
    ...
    },
    {
      ...
      "quotedText": "什克洛夫斯基的「陌生化」理论认为，艺术的功能是打破自动化感知，使熟悉之物变得陌生",
      "references": [
        {
