 ...
 * Artwork: "数息生长" by 程佳瑜 (Cheng Jiayu)
...
export const artwork5Dialogue = {
  ...
  "messages": [
    ...
    },
    {
      ...
      "replyTo": "professor-petrova",
      "interactionType": "question-challenge",
      "quotedText": "观众看到的只是表层，却可以通过表层推测深层——这正是形式主义分析的核心方法",
      "references": [
        {
